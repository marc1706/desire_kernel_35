...
EXPORT_SYMBOL_GPL(smd_write_atomic);

int smd_read_avail(smd_channel_t *ch)
{
	return ch->read_avail(ch);
}
EXPORT_SYMBOL_GPL(smd_read_avail);
...
EXPORT_SYMBOL_GPL(smd_cur_packet_size);
