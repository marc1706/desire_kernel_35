...
static int __init bravo_wifi_init(void)
{
	...
	bravo_wifi_update_nvs("btc_params80=0\n");
	bravo_wifi_update_nvs("btc_params6=30\n");

	strip_nvs_param("pa0maxpwr");
	bravo_wifi_update_nvs("pa0maxpwr=78\n");

	strip_nvs_param("opo");
	bravo_wifi_update_nvs("opo=20\n");

	strip_nvs_param("mcs2gpo0");
	bravo_wifi_update_nvs("mcs2gpo0=0xCCCC\n");

	strip_nvs_param("mcs2gpo1");
	bravo_wifi_update_nvs("mcs2gpo1=0xCCCC\n");

	strip_nvs_param("rxpo2g");
	bravo_wifi_update_nvs("rxpo2g=0\n");
